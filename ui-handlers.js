...
import { handleLogin, handleLogout, onAuthStateChanged } from './auth.js';
import { handleDeposit, handleWithdrawal, handleTransfer } from './transactions.js';
...
depositForm.addEventListener('submit', async (e) => {
    ...
    if (user) {
        await handleDeposit(user.uid, amount, currency, serialNumber, false); // Asume que se verifica el estado pendiente
        depositModal.classList.add('hidden');
        depositForm.reset();
    }
});
